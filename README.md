...
智渡的目标是成为这个全周期的「个人成长操作系统」：以 AI 志愿填报为入口，以大学生成长管理为纵深，构建一个从高二到大学毕业（约 6 年）的长期陪伴型产品。
...
1.3 产品名称
智渡（工作代号）—— "智"为 AI 智能，"渡"为摆渡、引渡，暗含从高中到大学的过渡意象。最终名称待定。
...
智渡的差异化: 唯一将志愿填报与大学四年成长管理整合、并用 AI 贯穿全周期的产品。不是做一堆独立工具，而是构建一个理解用户全貌的「数字分身」。
